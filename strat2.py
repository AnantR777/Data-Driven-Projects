...
ax[0].set_title('Strat 2: Time Window vs Total Return (validation on train set)')
...
ax[1].legend()
plt.savefig("Valdation and mavg for strat2.png")
plt.show()
...
plt.title('Strat 2: Value of position (theta) with Upper and Lower Bounds (train set)')
plt.xlabel('Date')
...
plt.legend()
plt.grid(True)
plt.savefig("Strat 2 train theta vs bounds.png")
plt.show()
...
# Define the moving average window, let's make it consistent with the best window
...
plt.title('Strat 2: 75-Day Moving Average of Dollar Turnover (train set)')
plt.xlabel('Date')
plt.ylabel('Turnover in Dollars')
plt.legend()
plt.grid(True)
plt.savefig("Strat 2 train mavg dollar turnover.png")
plt.show()
...
plt.title('Strat 2: 75-Day Moving Average of Unit Turnover (train set)')
plt.xlabel('Date')
plt.ylabel('Turnover in Units')
plt.legend()
plt.grid(True)
plt.savefig("Strat 2 train mavg unit turnover.png")
plt.show()
...
plt.title('Strat 2: delta V\'s Over Time (train set)')
plt.xlabel('Date')
plt.ylabel('Capital changes day on day in dollars')
plt.legend()
plt.grid(True)
plt.savefig("Strat 2 train delta V.png")
plt.show()
...
plt.title('Strat 2: V\'s Over Time (train set)')
plt.xlabel('Date')
plt.ylabel('Capital in dollars')
plt.legend()
plt.grid(True)
plt.savefig("Strat 2 train V.png")
plt.show()
...
plt.title('Strat 2 75-Day Rolling Sharpe Ratio (train set)')
plt.xlabel('Date')
plt.ylabel('Sharpe Ratio')
plt.legend()
plt.grid(True)
plt.savefig("Strat 2 train roll sharpe.png")
plt.show()
...
plt.title('Strat 2: Drawdown and 90-Day Rolling Volatility (train set)')
plt.savefig("Strat 2 train drawdown vol.png")
plt.show()
...
plt.title('Strat 2: Value of position (theta) with Upper and Lower Bounds (test set)')
plt.xlabel('Date')
plt.ylabel('Dollar Value')
plt.axhline(y=2000000, color='r', linestyle='-', linewidth=0.5)
plt.axhline(y=-2000000, color='r', linestyle='-', linewidth=0.5)
plt.legend()
plt.grid(True)
plt.savefig("Strat 2 test theta vs bounds.png")
plt.show()
...
plt.title('Strat 2: 75-Day Moving Average of Dollar Turnover (test set)')
plt.xlabel('Date')
plt.ylabel('Turnover in Dollars')
plt.legend()
plt.grid(True)
plt.savefig("Strat 2 test mavg dollar turnover.png")
plt.show()
...
plt.title('Strat 2: 75-Day Moving Average of Unit Turnover (test set)')
plt.xlabel('Date')
plt.ylabel('Turnover in Units')
plt.legend()
plt.grid(True)
plt.savefig("Strat 2 test mavg unit turnover.png")
plt.show()
...
plt.plot(merged_df.index[train_size:], deltaV, label='delta Vt')
plt.plot(merged_df.index[train_size:], delta_V_total, label='delta_V_total')
plt.title('Strat 2: delta V\'s Over Time (test set)')
plt.xlabel('Date')
plt.ylabel('Capital changes day on day in dollars')
plt.legend()
plt.grid(True)
plt.savefig("Strat 2 test delta V.png")
plt.show()
...
plt.plot(merged_df.index[train_size:], deltaV.cumsum(), label='Vt')
plt.plot(merged_df.index[train_size:], delta_V_total.cumsum(), label='Vt_total')
plt.title('Strat 2: V\'s Over Time (test set)')
plt.xlabel('Date')
plt.ylabel('Capital in dollars')
plt.legend()
plt.grid(True)
plt.savefig("Strat 2 test V.png")
plt.show()
...
plt.figure(figsize=(12, 6))
plt.plot(merged_df.index[train_size:], rolling_sharpe_ratio.fillna(0), label='75-Day Rolling Sharpe Ratio')
plt.title('Strat 2: 75-Day Rolling Sharpe Ratio (test set)')
plt.xlabel('Date')
plt.ylabel('Sharpe Ratio')
plt.legend()
plt.grid(True)
plt.savefig("Strat 2 test roll sharpe.png")
plt.show()
...
plt.title('Strat 2: Drawdown and 90-Day Rolling Volatility (test set)')
plt.savefig("Strat 2 test drawdown vol.png")
plt.show()